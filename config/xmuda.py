...
# ---------------------------------------------------------------------------- #
_C.TRAIN.XMUDA = CN()
_C.TRAIN.XMUDA.lambda_trg_2d = 0.0
_C.TRAIN.XMUDA.lambda_mix_2d = 0.0
_C.TRAIN.XMUDA.lambda_mix_3d = 0.0
...
_C.DATASET_SOURCE.SemanticKITTISCN.augmentation.use_aug = False
...
_C.DATASET_TARGET.SemanticKITTISCN.source = ''


# GTAKITTISCN
_C.DATASET_SOURCE.GTASCN= CN()
_C.DATASET_SOURCE.GTASCN.root = ''
_C.DATASET_SOURCE.GTASCN.list_path = ''
_C.DATASET_SOURCE.GTASCN.target = ''
_C.DATASET_SOURCE.GTASCN.merge_classes = True

# 2D
_C.DATASET_SOURCE.GTASCN.image_normalizer = ()
# 2D augmentation
_C.DATASET_SOURCE.GTASCN.augmentation = CN()
_C.DATASET_SOURCE.GTASCN.augmentation.resize = (480, 302)
_C.DATASET_SOURCE.GTASCN.augmentation.fliplr = 0.5
_C.DATASET_SOURCE.GTASCN.augmentation.color_jitter = (0.4, 0.4, 0.4)
# copy over the same arguments to target dataset settings
_C.DATASET_TARGET.GTASCN = CN(_C.DATASET_SOURCE.GTASCN)
_C.DATASET_TARGET.GTASCN.pselab_paths = tuple()
...
_C.OUTPUT_DIR = osp.expanduser('~/workspace/outputs/comodal/@')